...
class SelectedRectPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Rect globalRect = selectedObject!.paintBounds.shift(Offset(transform.getTranslation().x, transform.getTranslation().y));
    final Paint fillPaint = Paint()..color = fillColor.withAlpha(50)..style = PaintingStyle.fill;
    canvas.drawRect(globalRect, fillPaint);
    final Paint borderPaint = Paint()..color = borderColor..style = PaintingStyle.stroke..strokeWidth = borderWidth;
