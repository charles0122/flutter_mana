...
import 'package:mana_database/src/helpers/hive_helper.dart';
import 'package:mana_database/src/helpers/shared_preferences_helper.dart';
import 'package:mana_database/src/helpers/sqlite_helper.dart';
  ...
  Future<void> openDatabases({required List<UMEDatabase> databases}) async {
    for (var data in databases) {
      if (data is SqliteDatabase) {
        ...
        var path = await sqliteHelper.initDeleteDb(
          data.databaseName,
