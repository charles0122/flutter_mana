...
class MaterialTableViewDemoApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) => ValueListenableBuilder(
    ...
    builder:
        (context, targetPlatform, _) => MaterialApp(
          title: _title,
...
class _DemoPageState extends State<DemoPage>
  ...
  Widget build(BuildContext context) {
    ...
    return Directionality(
      textDirection:
          stylingController.useRTL.value
              ? TextDirection.rtl
              : TextDirection.ltr,
      child: Scaffold(
        appBar: AppBar(
        ...
        body: SafeArea(
          child: ShimmerPlaceholderShadeProvider(
            ...
            builder:
                (context, placeholderShade) => LayoutBuilder(
                  builder:
  ...
  Widget _buildBoxExample(
      ...
      dividers: TableViewDividersStyle(
        vertical: TableViewVerticalDividersStyle.symmetric(
          TableViewVerticalDividerStyle(
            ...
            wiggleOffset: stylingController.verticalDividerWiggleOffset.value,
    ...
    rowCount:
        stylingController.doExpansion.value ? (1 << 12) - 1 : ((1 << 31) - 1),
    ...
    bodyContainerBuilder:
        (context, bodyContainer) => RefreshIndicator.adaptive(
  ...
  ModalRoute<void> _createColumnControlsRoute(
    ...
    return TableColumnControlHandlesPopupRoute.realtime(
      ...
      popupBuilder:
          (context, animation, secondaryAnimation, columnWidth) =>
              PreferredSize(
                  ...
                  child: FadeTransition(
                    ...
                    child: Material(
                      ...
                      child: _DemoColumnEditor(
                        ...
                        onClickApply:
                            (flex, freezePriority, sticky) => setState(() {
  ...
  Widget _wrapRow(int index, Widget child) => KeyedSubtree(
    ...
    child: DecoratedBox(
      ...
      decoration: BoxDecoration(
        border:
            stylingController.lineDividerEnabled.value
    ...
    return (context, row, TableRowContentBuilder contentBuilder) {
      ...
      if (doExpansion) {
        ...
        content = ExpandableTableRow(
          ...
          child: SizedBox(height: _rowHeight, child: content),
        );
      }
...
class _DemoColumnEditor extends StatefulWidget {
  ...
  final void Function(int? flex, int? freezePriority, bool sticky) onClickApply;

  const _DemoColumnEditor({required this.column, required this.onClickApply});
...
class _DemoColumnEditorState extends State<_DemoColumnEditor> {
  ...
  void initState() {
    ...
    _freezePriorityController = TextEditingController(
      text: widget.column.freezePriority.toString(),
    );

    _flexController = TextEditingController(
      text: widget.column.flex.toString(),
    );
      ...
      Align(
        ...
        child: SizedBox(
          ...
          child: Material(
            ...
            color: Theme.of(
              context,
            ).scaffoldBackgroundColor.withValues(alpha: .9),
            child: InkWell(
              onTap: () {
                final freezePriority = int.tryParse(
                  _freezePriorityController.text,
                );
                final sticky = _stickyController.value;

                if (sticky && (freezePriority == null || freezePriority <= 0)) {
