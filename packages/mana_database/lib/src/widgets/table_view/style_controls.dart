...
class DemoStylingController with ChangeNotifier {
  ...
  late final _doPlaceholdersShift = _BoolConjunctionValueNotifier(
    doPlaceholders,
    true,
  );
...
class _BoolConjunctionValueNotifier extends ValueNotifier<bool> {
  _BoolConjunctionValueNotifier(this._other, super.value) {
...
class DemoStylingControlsPopup extends ModalRoute<void> {
  ...
  DemoStylingControlsPopup({required this.stylingController});
        ...
        child: SizedBox(
          ...
          child: IntrinsicHeight(
            child: Material(
              ...
              child: DemoStylingControls(controller: stylingController),
            ),
          ),
        ),
      ),
...
class DemoStylingControls extends StatelessWidget {
  ...
  const DemoStylingControls({super.key, required this.controller});
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text(style: theme.textTheme.titleLarge, 'Styling controls'),
          ),
          Divider(height: 1),
          ConstrainedBox(
              ...
              builder:
                  (context, currentPlatform, _) =>
                      DropdownButton<TargetPlatform?>(
                        ...
                        onChanged:
                            (value) => globalTargetPlatform.value = value,
                      ),
            ),
          ),
          Padding(
            padding: EdgeInsets.only(left: 16.0, right: 16.0, top: 4.0),
            child: Text('Vertical divider wiggle count', style: titleTextStyle),
          ),
          Padding(
          ...
          ListenableBuilder(
            ...
            builder:
                (context, _) => Slider.adaptive(
                  ...
                  onChanged:
                      (value) =>
                          controller.verticalDividerWiggleCount.value =
                              value.round(),
                ),
          ),
          Padding(
          ...
          ListenableBuilder(
            ...
            builder:
                (context, _) => Slider.adaptive(
                  ...
                  onChanged:
                      (value) =>
                          controller.verticalDividerWiggleOffset.value =
                              value.roundToDouble(),
                ),
          ),
          ListenableBuilder(
            ...
            builder:
                (context, child) => SwitchListTile.adaptive(
                  ...
                  onChanged:
                      (value) => controller.lineDividerEnabled.value = value,
                ),
          ),
          ListenableBuilder(
          ...
          ListenableBuilder(
            ...
            builder:
                (context, child) => SwitchListTile.adaptive(
                  ...
                  onChanged:
                      controller.doPlaceholders.value
                          ? (value) =>
                              controller.doPlaceholdersShift.value = value
                          : null,
                ),
          ),
        ],
