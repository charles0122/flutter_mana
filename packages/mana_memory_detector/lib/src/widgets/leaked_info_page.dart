...
/// 内存泄漏详情页
/// 展示一次或多次泄漏的引用链，支持翻页与删除记录
class MemoryLeakDetailsPage extends StatefulWidget {
  const MemoryLeakDetailsPage(
  ...
  State<StatefulWidget> createState() {
    return MemoryLeakDetailsPageState();
  }
}

/// 详情页状态，负责翻页、删除、滚动控制
class MemoryLeakDetailsPageState extends State<MemoryLeakDetailsPage> {
