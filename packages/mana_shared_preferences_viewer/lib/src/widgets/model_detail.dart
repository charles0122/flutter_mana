        ...
        child: Column(
          ...
          children: [
            DropdownButtonFormField<String>(
              ...
              onChanged:
                  (String? newValue) =>
                      setState(() => _selectedKind = newValue!),
            ),
            TextFormField(
              ...
              validator:
                  (value) =>
                      (value == null || value.trim().isEmpty)
                          ? t('shared_preferences_viewer.key_required')
                          : null,
            ),
            TextFormField(
                ...
                switch (_selectedKind) {
                  case 'double':
                    return isDouble(value)
                        ? null
                        : t('shared_preferences_viewer.value_must_double');
                  case 'bool':
                    return isBool(value)
                        ? null
                        : t('shared_preferences_viewer.value_must_bool');
                  case 'int':
                    return isInt(value)
                        ? null
                        : t('shared_preferences_viewer.value_must_int');
                  case 'List<String>':
                    return isListOfString(value)
                        ? null
                        : t(
